...
* Architectural intent — 28 workflows, 36 repositories, 28 route modules, 8 transition maps (Request, Job, Invoice, Lease, RentalApplication, Rfp, RfpQuote, CashflowPlan)
...
| Repositories | 36 | src/repositories/ — derived (excl. index.ts) |
