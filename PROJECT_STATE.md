...
* **Backend:** 27 route modules · 31 workflows · 27 repositories · 291 operations (225 URL paths) · `apps/api/openapi.yaml`
...
* Architectural intent — 31 workflows, 27 repositories, 27 route modules, 8 transition maps (Request, Job, Invoice, Lease, RentalApplication, Rfp, RfpQuote, CashflowPlan)
