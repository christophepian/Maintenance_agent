...
* Architectural intent — 28 workflows, 34 repositories, 28 route modules, 8 transition maps (Request, Job, Invoice, Lease, RentalApplication, Rfp, RfpQuote, CashflowPlan)
...
| Repositories | 34 | src/repositories/ — derived (excl. index.ts) |
