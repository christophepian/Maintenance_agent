...
> - **Pre-GA security (still deferred by design):** durable (Redis) rate limiting, CSP header, audit logging; `sandbox` still in the prod branch allowlist and sandbox routes registered in all envs.
