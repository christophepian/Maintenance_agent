...
| Database | PostgreSQL 16 via Docker. Prisma ORM. 92 models · 78 enums · 122 migrations. |
...
├── apps/api/prisma/
│   ├── schema.prisma    # 92 models · 78 enums
│   └── migrations/      # 122 dirs — never edit past migrations
