...
const KEYWORD_DICTIONARY: KeywordEntry[] = [
  ...
  // ── Plomberie / Sanitaires (plumbing & bathroom fixtures) ──
  { term: "shower", category: "Défauts", weight: 1.0 },
  { term: "douche", category: "Défauts", weight: 1.0 },
  { term: "dusche", category: "Défauts", weight: 1.0 },
  { term: "bath", category: "Défauts", weight: 0.8 },
  { term: "baignoire", category: "Défauts", weight: 1.0 },
  { term: "badewanne", category: "Défauts", weight: 1.0 },
  { term: "toilet", category: "Défauts", weight: 1.0 },
  { term: "toilettes", category: "Défauts", weight: 1.0 },
  { term: "toilette", category: "Défauts", weight: 1.0 },
  { term: "wc", category: "Défauts", weight: 1.0 },
  { term: "faucet", category: "Défauts", weight: 1.0 },
  { term: "tap", category: "Défauts", weight: 0.8 },
  { term: "robinet", category: "Défauts", weight: 1.0 },
  { term: "wasserhahn", category: "Défauts", weight: 1.0 },
  { term: "sink", category: "Défauts", weight: 0.8 },
  { term: "lavabo", category: "Défauts", weight: 1.0 },
  { term: "waschbecken", category: "Défauts", weight: 1.0 },
  { term: "blocked", category: "Défauts", weight: 1.0 },
  { term: "bouché", category: "Défauts", weight: 1.0 },
  { term: "verstopft", category: "Défauts", weight: 1.0 },
  { term: "clogged", category: "Défauts", weight: 1.0 },
  { term: "not running", category: "Défauts", weight: 1.0 },
  { term: "not working", category: "Défauts", weight: 1.0 },
  { term: "ne fonctionne plus", category: "Défauts", weight: 1.0 },
  { term: "funktioniert nicht", category: "Défauts", weight: 1.0 },
  { term: "no longer working", category: "Défauts", weight: 1.0 },
  { term: "out of service", category: "Défauts", weight: 1.0 },
  { term: "hors service", category: "Défauts", weight: 1.0 },
  { term: "außer betrieb", category: "Défauts", weight: 1.0 },
  { term: "dripping", category: "Dégâts d'eau", weight: 0.8 },
  { term: "coule", category: "Dégâts d'eau", weight: 0.8 },
  { term: "tropft", category: "Dégâts d'eau", weight: 0.8 },
  { term: "plomberie", category: "Dégâts d'eau", weight: 0.8 },
  { term: "klempner", category: "Dégâts d'eau", weight: 0.8 },
  { term: "drain", category: "Dégâts d'eau", weight: 0.8 },
  { term: "évacuation", category: "Dégâts d'eau", weight: 0.8 },
  { term: "abfluss", category: "Dégâts d'eau", weight: 0.8 },
